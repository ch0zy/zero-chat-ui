    ...
    <>
      ...
      <div style={{fontFamily:font,display:"flex",height:"100vh",background:color.bgOverlay,overflow:"hidden"}}>
        ...
        <div style={{width:300,flexShrink:0,display:"flex",flexDirection:"column",
          ...
          <div style={{padding:`${sp[5]}px ${sp[6]}px ${sp[4]}px`,borderBottom:`1px solid ${color.borderLighter}`}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:sp[3],
              background:color.bgOverlay,borderRadius:radius.md,
              border:`1px solid ${searchFocused ? color.borderPrimary : color.borderLighter}`,
              padding:`${sp[2]}px ${sp[4]}px`,transition:"border 120ms ease"}}>
              <span style={{color:color.iconDefault,display:"flex",flexShrink:0}}><SearchIcon/></span>
              <input value={search} onChange={e=>setSearch(e.target.value)}
                placeholder="Search conversations…"
                onFocus={()=>setSearchFocused(true)} onBlur={()=>setSearchFocused(false)}
                style={{flex:1,fontSize:13,color:color.typeBodyLight,
                  "::placeholder":{color:color.typePlaceholder}}}/>
            </div>
          </div>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
          ...
          {/* Input area */}
          <div style={{padding:`${sp[4]}px ${sp[7]}px ${sp[5]}px`,background:color.bgDefault,
            borderTop:`1px solid ${color.borderLighter}`}}>
            <div style={{display:"flex",alignItems:"flex-end",gap:sp[3],
              background:color.bgOverlay,borderRadius:radius.lg,
              border:`2px solid ${inputFocused ? color.borderPrimary : color.borderLighter}`,
              padding:`${sp[3]}px ${sp[4]}px`,transition:"border 120ms ease"}}>

              {/* Attachment */}
              <button style={{width:34,height:34,borderRadius:radius.md,border:"none",
                background:"none",cursor:"pointer",display:"flex",alignItems:"center",
                justifyContent:"center",color:color.iconDefault,flexShrink:0,marginBottom:1,
                transition:"color 120ms ease"}}
                onMouseEnter={e=>e.currentTarget.style.color=color.iconDark}
                onMouseLeave={e=>e.currentTarget.style.color=color.iconDefault}>
                <AttachIcon/>
              </button>
              ...
              <textarea value={input}
                ...
                rows={1}
                style={{flex:1,fontSize:14,color:color.typeBodyLight,lineHeight:"22px",
                  paddingTop:6,paddingBottom:6,maxHeight:120,overflowY:"auto"}}/>
              ...
              <button onClick={sendMessage}
                style={{width:36,height:36,borderRadius:radius.md,border:"none",
                  background:input.trim()?color.primary:color.bgDisabled,
                  cursor:input.trim()?"pointer":"default",
                  display:"flex",alignItems:"center",justifyContent:"center",
                  color:input.trim()?"#fff":color.typeDisabled,flexShrink:0,
            ...
            <div style={{marginTop:sp[2],textAlign:"center",fontSize:11,color:color.typeLabelLight}}>
              Press <kbd style={{background:color.borderLighter,borderRadius:2,padding:"1px 4px",
                fontFamily:font,fontSize:10}}>Enter</kbd> to send · <kbd style={{background:color.borderLighter,
                borderRadius:2,padding:"1px 4px",fontFamily:font,fontSize:10}}>Shift+Enter</kbd> for new line
            </div>
          </div>
        </div>
      </div>
